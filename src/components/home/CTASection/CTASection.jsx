/* ============================================
   CAPEO — CTA SECTION V5
   Split bord-à-bord avec bandes dorées.
   ============================================ */
...
export default function CTASection() {
  ...
  return (
    <section className="cta-split" ref={sectionRef}>
      ...
      <div className="cta-split__band"></div>
      ...
      <div className="cta-split__panel cta-split__panel--seller reveal">
        <div className="cta-split__panel-inner">
          ...
          <Link to="/proposer-un-actif" className="cta-split__btn cta-split__btn--primary">
            Publier un actif →
          </Link>
        </div>
      </div>
      ...
      <div className="cta-split__panel cta-split__panel--buyer reveal reveal-delay-1">
        <div className="cta-split__panel-inner">
          ...
          <Link to="/inscription" className="cta-split__btn cta-split__btn--ghost">
            Devenir acquéreur →
          </Link>
        </div>
      </div>
